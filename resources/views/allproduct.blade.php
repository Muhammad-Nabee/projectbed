        ...
        <div class="main-menu">
          <nav id="navbar_top" class="navbar navbar-expand-lg shadow ">
            <div class="container-fluid px-5">
              <a class="navbar-brand" href="{{ url('/') }}">BEDSTORE</a>
    ...
    <div id="sidebar2"  >
      ...
      <div class="FilterSidebar2"> 
        ...
        <form onsubmit="event.preventDefault();" role="search">
            ...
            <input id="search" type="search" placeholder="Search Products" autofocus required />
...
$collection = collect($products->bedsize_id);
...
?>
{{dd('1')}}
        {{dd(array_filter($products->bedsize_id,$type_id))}}
            @foreach(json_decode($products->bedsize_id) as $o)
...
HELP
    ...
    <a href="">Fix it form</a>
    <a href="">General Enquirys</a>
...
<div class="footer-Copyright">
  <h3>
    Copyright &copy 2022 @Bedsote.com | Powered By <a href="https://codify.pk" target="blank">Codify.pk</a>
  </h3>
</div>
